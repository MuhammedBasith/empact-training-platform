import {  createTrainer, deleteTrainer, getAllTrainers, getTrainerById, getTrainersForDropdown, getTrainingsAllocatedForATrainer, updateTrainer } from "../controllers/trainer-management";
