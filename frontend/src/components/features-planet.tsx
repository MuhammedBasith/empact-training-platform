          ...
          <div className="py-12 md:py-20">
            ...
            <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
              <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
                Empact boosts teamwork for better training outcomes.
              </h2>
            </div>
            {/* Planet */}
            ...
            <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
              <article>
                ...
                Empower your teams to work seamlessly together, enhancing productivity and engagement in training initiatives.
                </p>
              </article>
              <article>
                <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <p className="text-[15px] text-gray-400">
                Gain valuable insights into training effectiveness with detailed metrics on participation, progress, and outcomes, allowing you to make data-driven decisions.
                </p>
              </article>
              <article>
                <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <p className="text-[15px] text-gray-400">
                Track training performance across various metrics, such as completion rates, participant feedback, and skill acquisition, ensuring that your programs are meeting their objectives.
                </p>
              </article>
              <article>
                <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <p className="text-[15px] text-gray-400">
                Navigate the platform with ease, enabling quick access to resources, schedules, and reports, ensuring that everyone stays informed and engaged.
                </p>
              </article>
              <article>
                <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <p className="text-[15px] text-gray-400">
                Tailor training programs to meet your organization’s unique needs, including custom content, training paths, and certifications.
                </p>
              </article>
              <article>
                <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <p className="text-[15px] text-gray-400">
                Leverage feedback and insights to continuously refine and improve your training programs, ensuring they remain relevant and effective.
                </p>
              </article>
            </div>
          </div>
